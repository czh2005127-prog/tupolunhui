...
const DEFINITIONS: Dictionary = {
	...
	"lucky_one": {"boss_name": "绝对幸运", "fragment_name": "幸运碎片", "fragment_desc": "每轮将自己随机1颗非①骰变为①"},
	...
	"table_ghost": {"boss_name": "亡者席位", "fragment_name": "幽灵碎片", "fragment_desc": "每局第一次受到同化时免疫"},
	"alliance_oled": {"boss_name": "公开审判", "fragment_name": "同盟碎片", "fragment_desc": "每轮查看一名对手的1颗普通骰子"},
	...
	"dealer": {"boss_name": "高额底池", "fragment_name": "庄家碎片", "fragment_desc": "每局开局额外获得1颗骰子"},
	"dice_god": {"boss_name": "双重禁忌", "fragment_name": "破界碎片", "fragment_desc": "获得时立即得到3锈蚀点和50 XP"},
}
